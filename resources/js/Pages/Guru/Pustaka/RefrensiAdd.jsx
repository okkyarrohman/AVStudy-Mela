...
const CreateRefrensi = () => {
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            refrensiSumber: Yup.string().required("Sumber Refrensi harus diisi"),
            refrensiLink: Yup.mixed().required("Refrensi Link Refrensi harus diisi"),
        }),
        onSubmit: (values) => {
            const data = new FormData();
            data.append("judul", values.refrensiName);
            data.append("sumber", values.refrensiSumber);
            data.append("link", values.refrensiLink);
            console.log(data);
            router.post(`/guru/pustaka/refrensi`, data);
        },
    });
    return (
        <>
                    ...
                    <div className="my-5">
                        <div className="bg-white w-full shadow-xl border rounded-lg border-gray-300 ">
                            <div className="flex justify-between bg-purple-500 text-white p-4 w-full rounded-t-lg">
                                <h1 className=" font-bold">Tambah Refrensi</h1>
                            </div>
                                    ...
                                    <div className="my-2">
                                        ...
                                        <div>
                                            <input
                                                ...
                                                value={formik.values.refrensiName}
                                    ...
                                    <div className="my-2">
                                        ...
                                        <div>
                                            <input
                                                ...
                                                onChange={formik.handleChange}
                                                onBlur={formik.handleBlur}
                                                value={formik.values.refrensiSumber}
                                    ...
                                    <div className="my-2 mb-5">
                                        ...
                                        <div>
                                            <input
                                                ...
                                                onChange={formik.handleChange}
                                                onBlur={formik.handleBlur}
                                                value={formik.values.refrensiLink}
